...
export PATH="/home/jared/opt/apps/bin:$PATH"

# install trash-cli
alias rm='trash'

# set up bare git repo for tracking dotfiles
# https://gist.github.com/yosevu/eaf39c6dd6c9c0712b0254c836130aa7
...
export SPACK_EDITOR=code
. $(spack location -i lmod)/lmod/lmod/init/bash
module use ${HOME}/opt/spack-modules/linux-linuxmint22-x86_64/Core



# Enable fzf key bindings and completion
# Place this at the absolute end of your ~/.bashrc
if [ -f /usr/share/doc/fzf/examples/key-bindings.bash ]; then
  source /usr/share/doc/fzf/examples/key-bindings.bash
fi

# Enable vim bindings for fzf
